...
func (this *HashTest) TestSHA256(c *check.C) {
	p := []byte("TestSHA256")
	hash := HASH(pb.HashType_SHA256, p)
...
func (this *HashTest) TestSHA384(c *check.C) {
	p := []byte("TestSHA384")
	hash := HASH(pb.HashType_SHA384, p)
...
func (this *HashTest) TestSHA512(c *check.C) {
	p := []byte("TestSHA512")
	hash := HASH(pb.HashType_SHA512, p)
...
func (this *HashTest) TestSHA3224(c *check.C) {
	p := []byte("TestSHA3224")
	hash := HASH(pb.HashType_SHA3224, p)
...
func (this *HashTest) TestSHA3256(c *check.C) {
	p := []byte("TestSHA3256")
	hash := HASH(pb.HashType_SHA3256, p)
...
func (this *HashTest) TestSHA3384(c *check.C) {
	p := []byte("TestSHA3384")
	hash := HASH(pb.HashType_SHA3384, p)
...
func (this *HashTest) TestSHA3512(c *check.C) {
	p := []byte("TestSHA3512")
	hash := HASH(pb.HashType_SHA3512, p)
...
func (this *HashTest) BenchmarkMD5(c *check.C) {
	for i := 0; i < c.N; i++ {
		HASH(pb.HashType_MD5, []byte("BenchmarkMD5"))
	}
}

func (this *HashTest) BenchmarkSHA1(c *check.C) {
	for i := 0; i < c.N; i++ {
		HASH(pb.HashType_SHA1, []byte("BenchmarkSHA1"))
	}
}

func (this *HashTest) BenchmarkSHA224(c *check.C) {
	for i := 0; i < c.N; i++ {
		HASH(pb.HashType_SHA224, []byte("BenchmarkSHA224"))
	}
}

func (this *HashTest) BenchmarkSHA256(c *check.C) {
	for i := 0; i < c.N; i++ {
		HASH(pb.HashType_SHA256, []byte("BenchmarkSHA256"))
	}
}

func (this *HashTest) BenchmarkSHA384(c *check.C) {
	for i := 0; i < c.N; i++ {
		HASH(pb.HashType_SHA384, []byte("BenchmarkSHA384"))
	}
}

func (this *HashTest) BenchmarkSHA512(c *check.C) {
	for i := 0; i < c.N; i++ {
		HASH(pb.HashType_SHA512, []byte("BenchmarkSHA512"))
	}
}

func (this *HashTest) BenchmarkSHA3224(c *check.C) {
	for i := 0; i < c.N; i++ {
		HASH(pb.HashType_SHA3224, []byte("BenchmarkSHA3224"))
	}
}

func (this *HashTest) BenchmarkSHA3256(c *check.C) {
	for i := 0; i < c.N; i++ {
		HASH(pb.HashType_SHA3256, []byte("BenchmarkSHA3256"))
	}
}

func (this *HashTest) BenchmarkSHA3384(c *check.C) {
	for i := 0; i < c.N; i++ {
		HASH(pb.HashType_SHA3384, []byte("BenchmarkSHA3384"))
	}
}

func (this *HashTest) BenchmarkSHA3512(c *check.C) {
	for i := 0; i < c.N; i++ {
		HASH(pb.HashType_SHA3512, []byte("BenchmarkSHA3512"))
	}
}