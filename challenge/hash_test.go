...
func (t *HashTest) TestSHA512(c *check.C) {
	p := []byte("TestSHA512")
...
func (t *HashTest) TestSHA3384(c *check.C) {
	p := []byte("TestSHA3384")
...
func (t *HashTest) TestSHA3512(c *check.C) {
	p := []byte("TestSHA3512")
...
func (t *HashTest) BenchmarkMD5(c *check.C) {
	for i := 0; i < c.N; i++ {
		HASH(pb.HashAlgo_MD5, []byte("BenchmarkMD5"))
	}
}

func (t *HashTest) BenchmarkSHA1(c *check.C) {
	for i := 0; i < c.N; i++ {
		HASH(pb.HashAlgo_SHA1, []byte("BenchmarkSHA1"))
	}
}

func (t *HashTest) BenchmarkSHA224(c *check.C) {
	for i := 0; i < c.N; i++ {
		HASH(pb.HashAlgo_SHA224, []byte("BenchmarkSHA224"))
	}
}

func (t *HashTest) BenchmarkSHA256(c *check.C) {
	for i := 0; i < c.N; i++ {
		HASH(pb.HashAlgo_SHA256, []byte("BenchmarkSHA256"))
	}
}

func (t *HashTest) BenchmarkSHA384(c *check.C) {
	for i := 0; i < c.N; i++ {
		HASH(pb.HashAlgo_SHA384, []byte("BenchmarkSHA384"))
	}
}

func (t *HashTest) BenchmarkSHA512(c *check.C) {
	for i := 0; i < c.N; i++ {
		HASH(pb.HashAlgo_SHA512, []byte("BenchmarkSHA512"))
	}
}

func (t *HashTest) BenchmarkSHA3224(c *check.C) {
	for i := 0; i < c.N; i++ {
		HASH(pb.HashAlgo_SHA3224, []byte("BenchmarkSHA3224"))
	}
}

func (t *HashTest) BenchmarkSHA3256(c *check.C) {
	for i := 0; i < c.N; i++ {
		HASH(pb.HashAlgo_SHA3256, []byte("BenchmarkSHA3256"))
	}
}

func (t *HashTest) BenchmarkSHA3384(c *check.C) {
	for i := 0; i < c.N; i++ {
		HASH(pb.HashAlgo_SHA3384, []byte("BenchmarkSHA3384"))
	}
}

func (t *HashTest) BenchmarkSHA3512(c *check.C) {
	for i := 0; i < c.N; i++ {
